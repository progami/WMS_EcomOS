...
export async function POST(request: NextRequest) {
  try {
    ...
    const transactionDateObj = parseLocalDate(txDate)
        ...
        for (const item of itemsArray) {
          ...
          const transaction = await tx.inventoryTransaction.create({
            data: {
              ...
              transactionDate: parseLocalDate(txDate),
              pickupDate: pickupDate ? parseLocalDate(pickupDate) : parseLocalDate(txDate), // Use provided pickup date or default to transaction date
